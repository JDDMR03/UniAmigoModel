...
class ActionDefaultFallback(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(text="Lo siento, no cuento con la información para apoyarte. Puedes revisar la sección de '**Cómo usar UniAmigo**' para poder ayudarte.")
        return [] 